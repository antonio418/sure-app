...
- Empresa: Chengdu Qinchuan IoT Technology Co., Ltd.
- Contacto (Nombre completo): Mr. Chris Zhong
- Rol o Cargo en LinkedIn: Fabricante de Medidores Inteligentes de Electricidad (IoT)
- Sector o Productos: Smart Meters

REGLAS DE ADAPTACIÓN:
1. Saludo inicial:
   - Si el Contacto no es 'VACÍO', usa un saludo formal en inglés usando su apellido (ej: 'Dear Mr. Liu,' o 'Dear Allen Liu,').
   - Si el Contacto es 'VACÍO', usa el cargo/rol del prospecto (ej: 'Dear LATAM Sales Manager,' o 'Dear Sales Manager,') si es coherente. Si no, usa 'Dear Sales Team at Chengdu Qinchuan IoT,'.
