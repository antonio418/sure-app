...
... (omitted for brevity in prompt log, but fully loaded in the file)
`;
...
async function testModel(modelName) {
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction: "Eres ALFREDO, una unidad de inteligencia algorítmica especializada en la originación y extracción de leads.",
        temperature: 0.1,
        tools: [{ googleSearch: {} }],
    ...
    console.log(`Success with ${modelName}! Response candidates:`);
