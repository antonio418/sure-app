                ...
                {sortedLeads.length === 0 ? (
                  ...
                  sortedLeads.map(lead => (
                    <tr key={lead.id} className="border-b border-white/5 hover:bg-white/5">
                      ...
                      <td className="px-6 py-4 font-bold text-white">{lead.empresa}</td>
                      <td className="px-6 py-4">{lead.nombre_contacto}</td>
           ...
           <div className="bg-[#0a101f] border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl">
              ...
              <div className="space-y-4">
                 <div>
                    ...
                    <input type="text" value={newProject.name} onChange={e => setNewProject({...newProject, name: e.target.value})} placeholder="Ej: Germanio Europa Q3" className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-[var(--color-sure-accent)]" />
                 </div>
                 <div>
