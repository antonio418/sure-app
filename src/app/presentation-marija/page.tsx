...
const LOCAL_TRANSLATIONS: Record<string, any> = {
  lt: {
    ...
    s5_title: "Teisinis pagrindas: skaidrus paciento sutikimas",
    ...
    s5_right_p3: "Paciento nurodytos vizito priežasties administracinis registravimas ir perdavimas klinikai.",
    s5_footer: "Marija DI veikia griežtai laikantis ES Medicinos priemoniu reglamento (MDR 2017/745) išimčių, kaip grynai administracinis įrankis.",
    
    s6_title: "Teisinis pagrindas: skaidrus paciento sutikimas",
    s6_step1: "1. Paciento užklausa priimama.",
    s6_step2: "2. Marija DI pateikia pacientui klinikos vizitų registravimo sąlygas ir privatumo pranešimą.",
    s6_step3: "3. Pacientas patvirtina sutartį skaitmeniniu būdu.",
    s6_step4: "4. Vizitas patvirtinamas. Klinika turi dokumentuotą pagrindą taikyti aiškią atšaukimo politiką.",
    s6_footer: "Aiški atšaukimo politika ir dokumentuotas sutikimas – be jokių nepatogių pokalbių registratūroje.",
  ...
  es: {
    ...
    s5_title: "Base jurídica: consentimiento transparente del paciente",
    ...
    s6_title: "Base jurídica: consentimiento transparente del paciente",
    s6_step1: "1. Se recibe la consulta del paciente.",
    s6_step2: "2. Marija DI presenta al paciente las condiciones de registro de visitas y el aviso de privacidad.",
    s6_step3: "3. El paciente firma el contrato de forma digital y segura.",
    s6_step4: "4. Cita confirmada. La clínica tiene base documentada para aplicar una política clara de cancelación.",
    s6_footer: "Política clara de cancelación y consentimiento documentado, sin conversaciones incómodas en recepción.",
  ...
  en: {
    ...
    s5_title: "Legal basis: transparent patient consent",
    s5_left_title: "Strictly Forbidden / Griežtai draudžiama",
    ...
    s6_title: "Legal basis: transparent patient consent",
    s6_step1: "1. Patient inquiry is received.",
    s6_step2: "2. Marija DI presents to the patient the visit registration conditions and privacy notice.",
    s6_step3: "3. Patient signs the agreement digitally and securely.",
    s6_step4: "4. Appointment confirmed. Clinic has a documented basis to apply a clear cancellation policy.",
    s6_footer: "Clear cancellation policy and documented consent, without uncomfortable reception conversations.",
