...
const pdfTranslations: Record<string, any> = {
  en: {
    ...
    legalNotice: "LEGAL NOTICE: This B2B Certificate is generated in \"Good Faith\" by AI. It does not constitute legal advice or financial instruction. Operated by SURE Forensics under the laws of the Republic of Lithuania. Use of this document implies acceptance of the Master Services Agreement attached at the end of the report.",
    pageStr: "Page",
    msaTitle: "MASTER FORENSIC SERVICES AGREEMENT",
    msaClient: "CLIENT: Client / Platform User",
    msaContractor: "CONTRACTOR: SURE Forensics",
    msa1Title: "1. Scope of Services",
    msa1Desc1: "SURE Forensics agrees to provide an autonomous multi-agent intelligence analysis (RMA) on the documents submitted by the Client through its SURE Forensics platform. The result of this service is a \"B2B Risk Certificate\" that details possible anomalies, contractual asymmetries, and technical inconsistencies.",
    ...
    msa2Bullet4: "• Under no circumstances will SURE Forensics, its founders, its AI platform (SURE), or its affiliates be liable for any direct, indirect, incidental, or consequential financial loss, loss of profit, or legal disputes arising from the Client's transactions, regardless of the findings presented in the Intelligence Dossier.",
    msa3Title: "3. Service Level Agreement (SLA)",
    msa3Desc: "Upon receipt of the complete documentation and payment confirmation, SURE Forensics will deliver the final Intelligence Dossier within 24 to 48 business hours.",
    msa4Title: "4. Confidentiality",
    msa4Desc: "SURE Forensics will treat all generated information as strictly confidential and may under no circumstances provide it to third parties without the written authorization of the contracting company.",
  ...
  es: {
    ...
    legalNotice: "AVISO LEGAL: Este Certificado B2B es generado de \"Buena Fe\" por IA. No constituye asesoría legal ni instrucción financiera. Operado por SURE Forensics bajo las leyes de la República de Lituania. El uso de este documento implica la aceptación del Acuerdo de Servicios Maestro adjunto al final del reporte.",
    pageStr: "Página",
    msaTitle: "ACUERDO MAESTRO DE SERVICIOS FORENSES",
    msaClient: "CLIENTE: Cliente / Usuario de Plataforma",
    msaContractor: "CONTRATISTA: SURE Forensics",
    msa1Title: "1. Alcance de los Servicios",
    msa1Desc1: "SURE Forensics acuerda proveer un análisis de inteligencia multi-agente autónomo (RMA) sobre los documentos enviados por el Cliente mediante la plataforma SURE Forensics. El resultado es un \"Certificado de Riesgo B2B\" que detalla posibles anomalías, asimetrías contractuales e inconsistencias técnicas.",
    ...
    msa2Desc1: "El Certificado de Riesgo B2B se genera de forma autónoma y de \"Buena Fe\" por algoritmos de IA, basándose en cruce de datos, análisis semántico y matrices de probabilidad. SURE Forensics es un Proveedor de Inteligencia Operacional, no un asesor financiero.",
    ...
    msa2Bullet4: "• Bajo ninguna circunstancia SURE Forensics o sus afiliados serán responsables por ninguna pérdida financiera derivada de las transacciones del Cliente.",
    msa3Title: "3. Acuerdo de Nivel de Servicio (SLA)",
    msa3Desc: "Tras la recepción de la documentación completa y confirmación de pago, SURE Forensics entregará el Dossier de Inteligencia final dentro de 24 a 48 horas hábiles.",
    msa4Title: "4. Confidencialidad",
    msa4Desc: "SURE Forensics tratará toda la información generada como estrictamente confidencial y bajo ninguna circunstancia la proveerá a terceros sin la autorización escrita de la empresa contratante.",
  ...
  pt: {
    ...
    legalNotice: "AVISO LEGAL: Este Certificado B2B é gerado de \"Boa Fé\" por IA. Não constitui aconselhamento jurídico ou instrução financeira. Operado por SURE Forensics sob as leis da República da Lituânia. O uso deste documento implica a aceitação do Contrato Principal de Serviços em anexo no final do relatório.",
    pageStr: "Página",
    msaTitle: "CONTRATO PRINCIPAL DE SERVIÇOS FORENSES",
    msaClient: "CLIENTE: Cliente / Usuário da Plataforma",
    msaContractor: "CONTRATADA: SURE Forensics",
    msa1Title: "1. Escopo dos Serviços",
    msa1Desc1: "A SURE Forensics concorda em fornecer uma análise de inteligência multiagente autônoma (RMA) sobre os documentos enviados pelo Cliente através de sua plataforma SURE Forensics. O resultado deste serviço é um \"Certificado de Risco B2B\" que detalha possíveis anomalias, assimetrias contratuais e inconsistências técnicas.",
    ...
    msa2Desc1: "O Certificado de Risco B2B é gerado de forma autônoma e de \"Boa Fé\" por algoritmos de inteligência artificial, com base no cruzamento de dados de rede, análise semântica e matrizes de probabilidade. A SURE Forensics é uma Provedora de Inteligência Operacional, não um consultor financeiro.",
    ...
    msa2Bullet4: "• Sob nenhuma circunstância a SURE Forensics ou suas afiliadas serão responsáveis por qualquer perda financeira derivada das transações do Cliente.",
    msa3Title: "3. Acordo de Nível de Serviço (SLA)",
    msa3Desc: "Após o recebimento da documentação completa e confirmação de pagamento, a SURE Forensics entregará o Dossiê de Inteligência final dentro de 24 a 48 horas úteis.",
    msa4Title: "4. Confidencialidade",
    msa4Desc: "A SURE Forensics tratará todas as informações geradas como estritamente confidenciais e não as fornecerá a terceiros sem a autorização por escrito da empresa contratante.",
  ...
  fr: {
    ...
    msaContractor: "ENTREPRENEUR : SURE Forensics",
    msa1Title: "1. Étendue des Services",
    msa1Desc1: "SURE Forensics s'engage à fournir une analyse...",
    ...
    msa2Bullet4: "• SURE Forensics n'est pas responsable des pertes.",
    msa3Title: "3. Accord de Niveau de Service",
    msa3Desc: "SURE Forensics livrera le Dossier final dans les 24-48 heures.",
  ...
  de: {
    ...
    msaContractor: "AUFTRAGNEHMER: SURE Forensics",
    msa1Title: "1. Leistungsumfang",
    msa1Desc1: "SURE Forensics erbringt eine autonome Analyse...",
    ...
    msa2Bullet4: "• SURE Forensics nicht für Verluste haftet.",
  ...
  zh: {
    ...
    msaTitle: "取证服务主协议",
    msaClient: "客户：平台用户",
    msaContractor: "承包商：SURE Forensics",
    msa1Title: "1. 服务范围",
    ...
    msa2Bullet4: "• SURE Forensics不对损失负责。",
    msa3Title: "3. 服务级别协议",
  ...
  ru: {
    ...
    msaContractor: "ПОДРЯДЧИК: SURE Forensics",
    msa1Title: "1. Объем услуг",
    msa1Desc1: "SURE Forensics обязуется предоставить автономный анализ...",
    ...
    msa2Bullet4: "• SURE Forensics не несет ответственности за убытки.",
  ...
  ar: {
    ...
    msaContractor: "المقاول: SURE Forensics",
  ...
  hi: {
    ...
    msaContractor: "ठेकेदार: SURE Forensics",
    ...
    msa2Bullet4: "• SURE Forensics नुकसान के लिए उत्तरदायी नहीं है।",
